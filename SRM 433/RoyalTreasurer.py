...
def do_test(A, B, __expected):
    startTime = time.time()
    instance = RoyalTreasurer()
    exception = None
    try:
        __result = instance.minimalArrangement(A, B);
    except:
        import traceback
...
def run_tests():
    sys.stdout.write("RoyalTreasurer (250 Points)\n\n")
    ...
    with open("RoyalTreasurer.sample", "r") as f:
        while True:
            label = f.readline()
