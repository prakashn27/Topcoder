...
public class RelativeHeights {
	public int countWays(int[] h) {
		...
		for(int i = 0; i < h.length; i++) {
			String str = removeElements(h,i);
			String ord = order(str);
			// System.out.println(str + ":" + ord);
			set.add(ord);
		}
  ...
  //       s = list.toArray();
  //       String sorted = s.toString();
		// StringBuilder sb = new StringBuilder();
		// for(char i : str.toArray()) {
		// 	sb.append(sorted.indexOf(i));
		// }
		// return sb.toString();
	...
	private String removeElements(int[] input, int index) {
...
// CUT begin
	...
	static void runTest(HashSet<Integer> caseSet) {
        ...
        int T = (int)(System.currentTimeMillis() / 1000) - 1499919650;
